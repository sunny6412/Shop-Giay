          ...
          <div class="col-md-12">
              ...
              @csrf
                <div class="form-group">
                  ...
                  <input type="text" value="{{old('name')}}" name="name" class="form-control " placeholder="Nhập tên vai trò">  
                ...
                <div class="card border-primary mb-3 col-md-12" >
                    ...
                    <div class="row">
                        ...
                        <div class="card-body text-primary col-md-3">
                            <h5 class="card-title">
                                <label for="">
                                    <input type="checkbox" class="checkbox_childrent" name="permission_id[]" value="{{$item->id}}">
                                </label>
                              {{$item->name}}
                            </h5>
                              </div>
