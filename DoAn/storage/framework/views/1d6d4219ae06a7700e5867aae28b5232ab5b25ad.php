...
<div class="container">
    ...
    <?php endif; ?>
    <?php if(session('alert_email')): ?>
        <div class="alert alert-danger">
            <?php echo e(session('alert_email')); ?>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('sign_up.signUp')); ?>">
                        <?php echo csrf_field(); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/DoAn/resources/views/auth/signup.blade.php ENDPATH**/ ?>